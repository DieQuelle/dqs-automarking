...
`;
  ...
  // Überprüfen Sie, ob am Ende ein Komma steht, bevor Sie es entfernen
  ...
  if (updatedText === customText) {
    alert('Der Platzhalter "authorOptions" wurde nicht gefunden oder die Daten sind im falschen Format.');
    return;
  }
